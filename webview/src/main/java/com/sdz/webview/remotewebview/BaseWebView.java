package com.sdz.webview.remotewebview;
...
import com.sdz.webview.remotewebview.callback.WebViewCallBack;
import com.sdz.webview.remotewebview.javascriptinterface.WebviewJavascriptInterface;
import com.sdz.webview.remotewebview.settings.WebviewDefaultSetting;
import com.sdz.webview.remotewebview.webviewclient.MyWebviewClient;
...
public class BaseWebView extends WebView implements MyWebviewClient.WebviewTouch {
    ...
    public void registerdWebViewCallBack(WebViewCallBack webViewCallBack) {
        ...
        mMyWebviewClient = new MyWebviewClient(this, webViewCallBack, mHeaders, this);
