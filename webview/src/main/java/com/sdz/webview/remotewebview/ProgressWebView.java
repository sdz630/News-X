...
import com.sdz.webview.remotewebview.progressbar.IndicatorHandler;
import com.sdz.webview.remotewebview.progressbar.WebProgressBar;
import com.sdz.webview.remotewebview.webchromeclient.ProgressWebChromeClient;


public class ProgressWebView extends BaseWebView {

    public static final String TAG = "sdz";
